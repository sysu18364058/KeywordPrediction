...
class Trainer:
    ...
    def _training_step(
        ...
        # inputs['soft_flag'] = False
        if self.medical_knowledge is not None:
            inputs['words_to_cui'] = self.medical_knowledge[0]
            inputs['cui_to_words'] = self.medical_knowledge[1]
            inputs['soft_flag'] = True
